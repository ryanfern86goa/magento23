...
Disallow: /*SID=
            ...
            'general' => [
                ...
                'region' => [
                    'display_all' => '1',
                    'state_required' => 'BR,CA,CH,EE,ES,HR,IN,LT,LV,RO,US',
                ],
            ],
            'theme' => [
                'customization' => [
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'msp_securitysuite_twofactorauth' => [
                ...
                'duo' => [
                    'application_key' => 'Jz8b5erCrvkzHLaOnHKqO3rojd2JL4Y64SxVYT4pMyobnZYLyxbsJhb2rh5nM6IE',
                ],
            ],
            'contact' => [
                'contact' => [
            ...
            'connector_dynamic_content' => [
                ...
                'external_dynamic_content_urls' => [
                    'passcode' => 'Fx5eSZWmZ8RPN7F94AZWZjoucH2nd3lB',
